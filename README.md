...
Quantized 4-bit matmul (3072x3072, M3 Max):
...
Julia beats or matches MLX at B=4-128 for FP16 and B=8 for quantized. The remaining gap at large batch sizes is from load instruction overhead in the compiled IR ([details](docs/metal-matmul-optimization.md)).
